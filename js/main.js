...
function selected(id){
  document.getElementById("botao"+id).className += " selected";
  document.getElementById("opcao"+id).selected=true;
}
...
/*document.getElementById("mobilemenu").onchange = function() {
...
function identificar(videoid){
  ...
  formulario.innerHTML='<iframe src="/php/identificar/'+videoid+'/" width="100%" height="180px" frameborder="0" scrolling="no"></iframe>';
}
...
function changePos() {
    ...
    var gosto = document.getElementById("navgosto");
    if (window.pageYOffset > 100) {
        header.style.position = "fixed";
        header.style.top = "0";
        logo.style.display="block";
        gosto.style.opacity=0;
        
    } else {
        header.style.position = "";
        header.style.top = "";
        logo.style.display="none";
        gosto.style.opacity=1;
    }
}
